...
export class TableNumbersPage implements AfterContentChecked {
  ...
  public toAudio(numero: string) {
    this.audio.src = 'assets/sonidos/numeros/' + numero + this.data.getAbreviatura() + '.mp3';
    this.audio.pause();
    this.audio.load();
    this.audio.play();
  }
