...
export class TablePage implements AfterContentChecked {
  ...
  public toAudio(animal: string) {
    this.audio.src = 'assets/sonidos/animales/' + animal + this.data.getAbreviatura() + '.mp3';
    this.audio.pause();
    this.audio.load();
    this.audio.play();
  }
